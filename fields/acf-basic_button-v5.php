...
if( !class_exists('acf_field_basic_button') ) :


class acf_field_basic_button extends acf_field {
	...
	*/
	...
	function render_field( $field ) {
		...
		?>
			...
			<table class="acf-basic-button-fields">
				<tr>
					<td valign="top">
						<label><?php _e('Text', 'acf-basic_button'); ?></label>
						<input type="text" value="<?php echo esc_attr( $field['value']['text'] ); ?>" name="<?php echo $field_name; ?>[text]" class="text" />
					</td>
					<td valign="top">
						<label><?php _e('URL', 'acf-basic_button'); ?></label>
						<input type="text" value="<?php echo esc_attr( $field['value']['url'] ); ?>" name="<?php echo $field_name; ?>[url]" class="text" />
					</td>
					<td valign="top">
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script( 'acf-input-basic_button', "{$url}assets/js/input.js", array('acf-input'), $version );
		wp_enqueue_script('acf-input-basic_button');


		// register & include CSS
		wp_register_style( 'acf-input-basic_button', "{$url}assets/css/input.css", array('acf-input'), $version );
		wp_enqueue_style('acf-input-basic_button');
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-basic_button'),
		}
...
// initialize
new acf_field_basic_button( $this->settings );
